...
namespace Mono.Android.Crasher.Data
{
    ...
    static class ReportDataFactory
    {
        ...
        public static ReportData BuildReportData(Context context, ReportField[] reportFields, Time appStartDate, string initialConfiguration, Exception ex, bool isSilentReport)
        {
            var crashReportData = new ReportData();
            try
            {
                crashReportData.Add(ReportField.StackTrace, Java.Lang.Throwable.FromException(ex).StackTrace);
